...
const props = defineProps<{
  question: components['schemas']['FreeTextQuestionResponse']
  answer?: components['schemas']['FreeTextAnswerResponse'] // 未回答のときundefined
  userId: string
}>()
...
const editingContent = ref<string | undefined>(props.answer?.content)
